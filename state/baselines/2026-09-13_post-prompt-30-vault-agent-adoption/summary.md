# arcanium baseline — 2026-09-13_post-prompt-30-vault-agent-adoption

**Purpose:** post-state after Prompt 30 Vault Agent adoption — vault.js's hand-rolled AppRole login and DB-credential rotation retry loops replaced by a real HashiCorp Vault Agent sidecar; live-proven against an actual vault-1 outage during Agent's own re-auth
**Captured:** 2026-09-13T09:53:00Z
**Source commit:** 88899a7
**Previous baseline:** 2026-09-13_pre-prompt-30-vault-agent-adoption
